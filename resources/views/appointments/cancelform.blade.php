    	...
    	<div class="modal-dialog">
      	<!-- Modal content-->
      		<div class="modal-content">
        		...
        		<form class="form-horizontal" method="PATCH" action="/appointments/{{ $appointment->id }}/cancel" id="cancel-appointments-form">
					{{ csrf_field() }}
		...
		$(document).off('click','.submit-btn').on('click','.submit-btn', function(e){
	        ...
	        $.ajax({
	          ...
	          success: function(result){
	            ...
	            $("#appointment-history-table").DataTable().ajax.url( '/appointments/get_datatable_appointhistory' ).load();
	            $('.modal').modal('hide');
	          },
